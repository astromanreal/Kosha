...
export const metadata: Metadata = {
  title: 'Annamaya Kosha (Physical Body) Guide | Nutrition & Wellness',
  description: 'Explore the Annamaya Kosha, the physical sheath. Learn about Ayurvedic nutrition, hydration, sleep, exercise, and lifestyle practices for a healthy physical body.',
  keywords: ['Annamaya Kosha', 'Physical Body', 'Ayurveda', 'Nutrition', 'Wellness', 'Yoga', 'Holistic Health', 'Diet', 'Sleep', 'Exercise'],
  openGraph: {
    title: 'Annamaya Kosha (Physical Body) Guide | Kosha Explorer',
    description: 'Deep dive into the Annamaya Kosha. Learn about Ayurvedic nutrition, hydration, sleep, exercise, and lifestyle practices for a vibrant physical body.',
    url: `${siteBaseUrl}/physical-body`,
    type: 'article',
    images: [
      {
        url: `https://picsum.photos/seed/annamaya-kosha-og/1200/630`,
        width: 1200,
        height: 630,
        alt: 'Annamaya Kosha - The Physical Body',
      },
    ],
  },
  twitter: {
    ...
    title: 'Annamaya Kosha (Physical Body) Guide | Kosha Explorer',
    description: 'Nourish your physical body with insights on diet, hydration, sleep, and exercise from an Ayurvedic perspective.',
    images: [`https://picsum.photos/seed/annamaya-kosha-twitter/1200/630`],
  },
};
